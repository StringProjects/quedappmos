...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { accepted: @proposal.accepted, comment: @proposal.comment } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { accepted: @proposal.accepted, comment: @proposal.comment } }
